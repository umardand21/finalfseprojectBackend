...
@Service
@Log4j2
public class ProcessPensionServiceImpl implements ProcessPensionService,PensionerDetailClient,AuthorizationClient,PensionDisbursementClient {
	...
	@Override
	public PensionerDetail getPensionerDetailByAadhaar(String header, long aadhaarNumber) {
		// TODO Auto-generated method stub
		return new PensionerDetail(header, null, header, aadhaarNumber, aadhaarNumber, header, null);
	}

	@Override
	public ProcessPensionResponse getcode(String header, ProcessPensionInput processPensionInput)
			throws IOException, PensionerNotFoundException {
		// TODO Auto-generated method stub
		return new ProcessPensionResponse();
	}

	@Override
	public boolean authorizeRequest(String header) {
		// TODO Auto-generated method stub
		return true;
	}
	@Bean
